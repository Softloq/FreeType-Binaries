...
cmake -S %~dp0Prerequisite -B %~dp0build/Prerequisite -DFREETYPE_VERSION="%FREETYPE_VERSION%"
...
cmake -S %~dp0Package -B %~dp0build/Package -DFREETYPE_VERSION="%FREETYPE_VERSION%" -DPACKAGE_NAME="freetype-win64-msvc.zip"
